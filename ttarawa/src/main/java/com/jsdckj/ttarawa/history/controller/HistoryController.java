...
public class HistoryController {
  ...
  public ResponseEntity<?> insertHistory(HttpServletRequest request, @Parameter(description = "Files to be uploaded", content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE))@RequestPart MultipartFile image, @RequestPart(value = "history", required = false) HistoryReqDto historyReqDto) throws IOException {
